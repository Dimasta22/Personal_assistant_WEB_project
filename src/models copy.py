...
class Contact(db.Model):
    ...
    emails = relationship('Email', cascade="all,delete", backref='contacts')
    addresses = relationship('Address', cascade="all,delete", backref='contacts')
    phones = relationship('Phone', cascade="all,delete", backref='contacts')
